...
# load data
peak_values <- read_csv('../data/peak_cbv_table_mk801_025.csv')
...
write.csv(res_aov2, "res_peak_anova_twoway_mk801_025.csv", row.names=FALSE)
...
write.csv(res_pwc_treatment,"res_peak_pwc_mk801_025.csv")
...
write.csv(res_eff_size_treatment,"res_peak_eff_size_mk801_025.csv")
